          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground leading-relaxed">
                  By accessing and using the services of DD21 Tradings, you
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4 text-muted-foreground">
                  <p>DD21 Tradings provides the following services:</p>
                  ...
                  <ul className="space-y-3 ml-4">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        financial situation, investment objectives, and risk
                        tolerance
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                      <span>
                        Promptly notify us of any material changes in your
                    ...
                    <li className="flex items-start gap-2">
                      <span className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                      <span>
                        Make independent investment decisions and not hold us
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    Our fee structure is transparent and will be clearly
                    communicated before engaging our services. Fees may include:
                  </p>
                  <ul className="space-y-2 ml-4">
                    <li className="flex items-start gap-2">
                      <span className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                      <span>
                        Advisory fees based on assets under management or fixed
                        fee structure
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                      <span>
                        Performance-based fees where applicable and permitted by
                        regulations
                      </span>
                    </li>
                  </ul>
                  <p>
                    All fees are exclusive of applicable taxes and statutory
                    charges.
                  </p>
                </div>
              </CardContent>
              ...
              <CardContent>
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    ...
                    and will not disclose any personal or financial information
                    to third parties without your explicit consent, except as
                    required by law or regulatory authorities.
                  </p>
                  <p>
                    Client information may be shared with our authorized
                    personnel and service providers on a need-to-know basis for
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    Either party may terminate the advisory relationship with 30
                  ...
                  <ul className="space-y-2 ml-4">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                      <span>
                        We will provide a final account statement and return any
                        client documents
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                      <span>
                        Confidentiality obligations will continue beyond
                        termination
                      </span>
                    </li>
                  </ul>
            ...
            <Card className="bg-muted">
              <CardContent className="p-6">
                <p className="text-sm text-muted-foreground leading-relaxed">
                  <strong>Last Updated:</strong> January 2024. We reserve the
                  right to modify these terms at any time. Continued use of our
                  services after modifications constitutes acceptance of the
                  updated terms. For questions about these terms, contact us at{" "}
                  <a
